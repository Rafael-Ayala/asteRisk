...
hpop2 <- function(position, velocity, dateTime, times, satelliteMass, dragArea, 
    ...
    JPLephemerides <- JPLephemeridesDE440(MJD_TDB, centralBody=centralBody)
    realCentralBody <- determineCentralBody(position, JPLephemerides[-c(1, 2, 12, 13)], JPLephemerides[[12]])
