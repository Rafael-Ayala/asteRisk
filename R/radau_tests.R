...
# #
# #
# test=asteRisk:::readNavigationRINEXfile("inst/testRINEX.06g", 4,
#                                        asteRisk:::parseNavigationRINEXlinesGLONASSv21)
...
# 
# n <- asteRisk:::semiMajorAxistToMeanMotion(test_koe$semiMajorAxis)
# 
# 
...
# glonass_mass <- 1480
# glonass_area <- 30.9 + 4.2 + 1.7 # http://navigation-office.esa.int/attachments_12649497_1_Flohrer_ILRS_WS_2015.pdf
# ref_rho <- 0.1570
